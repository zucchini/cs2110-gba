...
function downloadROM(gamename) {
    Iodine.pause();
    var url = "binaries/" + gamename + ".gba";
    showTempString("Downloading \"" + url + ".\"");
...
function registerGUIEvents() {
    ...
    Iodine.attachSpeedHandler(function (speed) {
        document.title = location.hash.substr(1) + " - " + speed;
    });
}
